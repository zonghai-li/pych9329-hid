...
SHIFTED = {
    '!': ('1', MOD_LSHFT), '@': ('2', MOD_LSHFT), '#': ('3', MOD_LSHFT),
    '$': ('4', MOD_LSHFT), '%': ('5', MOD_LSHFT), '^': ('6', MOD_LSHFT),
    '&': ('7', MOD_LSHFT), '*': ('8', MOD_LSHFT), '(': ('9', MOD_LSHFT),
    ')': ('0', MOD_LSHFT), '_': ('-', MOD_LSHFT), '+': ('=', MOD_LSHFT),
    '{': ('[', MOD_LSHFT), '}': (']', MOD_LSHFT), '|': ('\\', MOD_LSHFT),
    ':': (';', MOD_LSHFT), '"': ('\'', MOD_LSHFT), '~': ('`', MOD_LSHFT),
    '<': (',', MOD_LSHFT), '>': ('.', MOD_LSHFT), '?': ('/', MOD_LSHFT),
}
...
SPECIAL_KEYS = {
    ...
    'right': 0x4F, 'left': 0x50, 'down': 0x51, 'up': 0x52, 'enter': 0x28, 
    'backspace': 0x2A, 'tab': 0x2B, 'esc': 0x29, 'space': 0x2C,
    
    # Numpad keys
    'num0': 0x62, 'num1': 0x59, 'num2': 0x5A, 'num3': 0x5B, 'num4': 0x5C,
    'num5': 0x5D, 'num6': 0x5E, 'num7': 0x5F, 'num8': 0x60, 'num9': 0x61,
    'numlock': 0x53, 'numclear': 0x54, 'numenter': 0x58,
    'numdivide': 0x54, 'nummultiply': 0x55, 'numsubtract': 0x56,
    'numadd': 0x57, 'numdecimal': 0x63,
}
